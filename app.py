        ...
        if error:
            ...
            if inspected_tag == MY_TAG and conqueror_stats:
                ...
                ledger_html = (
                    ...
                    f'<div class="stat-card"><div class="stat-title">Total Attacks Won<br>this month</div><div class="stat-value sc-font" style="font-size:1.8rem; color:#facc15;">+{monthly_wins} ⚔️</div></div>'
